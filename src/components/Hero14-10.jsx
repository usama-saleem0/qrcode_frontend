                                                                ...
                                                                <TabPanel>
                                                                    ...
                                                                    <div className="ar-bar-box" >
                                                                        ...
                                                                        <button className='qr-card'
                                                                            onClick={(e) => {
                                                                                setQrs(qr_code_none, 140, 12, 10);  
                                                                                // e.target.style.borderColor = '#f55600';
                                                                            }}>
                                                                            <img src={qr_code_none} alt=""
                                                                                style={{
                                                                                    width: '30px',
                                                                                    height: '32px'   // Corrected typo
                                                                                }}
                                                                            />
                                                                        </button>
                                                                        ...
                                                                        <button className='qr-card' onClick={() => setQrs(svg4String, 120, 33, 56)}><img src={btn11} alt="" /></button>
                                                                        ...
                                                                        <button className='qr-card' onClick={() => setQrs(svg9String, 120, 39, 15)}><img src={btn15} alt="" /></button>
                                                                        <button className='qr-card' onClick={() => setQrs(svg16String, 100, 39, 35)}><img src={btn19} alt="" /></button>
                                                                        <button className='qr-card' onClick={() => setQrs(svg10String, 120, 65, 10)}><img src={btn17} alt="" /></button>
                                                                        <button className='qr-card' onClick={() => setQrs(svg11String, 120, 65, 10)}><img src={btn14} alt="" /></button>
                                                                        <button className='qr-card' onClick={() => setQrs(svg12String, 110, 37, 35)}><img src={btn20} alt="" /></button>
                                                                        <button className='qr-card' onClick={() => setQrs(svg13String, 100, 50, 50)}><img src={btn21} alt="" /></button>
                                                                        <button className='qr-card' onClick={() => setQrs(svg14String, 100, 57, 10)}><img src={btn18} alt="" /></button>
                                                                        <button className='qr-card' onClick={() => setQrs(svg15String, 90, 25, 10)}><img src={btn16} alt="" /></button>
                                                            ...
                                                            <div className="qr-tab-box">
                                                                <TabPanel>
                                                                    ...
                                                                    <div className="ar-bar-box">
                                                                        ...
                                                                        <button className='qr-card' onClick={(e) => setQrs(qr_code_none, 140, 12, 10)}><img src={qr_code_none} alt=""
                                                                            style={
                                                                                {
                                                                                    width: '70%',
                                                                                    height: '55%',
                                            ...
                                            <TabPanel>
                                                <div className="Website-url-box">
                                                    <div className="input-Email">
                                                        ...
                                                        <div className="Email-in-box">
                                                            <h2>{t('Number_bk')}</h2>
                                                            <input type="text" name='SMSNumber' value={SMSNumber} onChange={(e) => {
                                        ...
                                        {qrCode && getQRCodeValue() ? (
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <div id='qrCodeContainer' ref={qrCodeRef} style={{ position: 'relative', marginTop: `${margin}px`, marginLeft: '10px' }}></div>
                                                </div>
                                            </div>
                                        ) : (
