...
import ic2 from '../img/list.png';
import ic3 from '../img/wifi.png';
import ic4 from '../img/book.png';
import ic5 from '../img/mail.png';
import ic6 from '../img/whatsapp.png';
import ic7 from '../img/sms.png';
import ic8 from '../img/pdf_1.png';
import ic9 from '../img/products.png';
import ic10 from '../img/book.png';
import ic11 from '../img/image-gallery.png';
import ic12 from '../img/list.png';
import ic13 from '../img/house.png';
import ic14 from '../img/menu_new.png';
import ic15 from '../img/promo-code.png';
import ic16 from '../img/mp3_new.png';
import ic17 from '../img/ui-design.png';
import ic18 from '../img/browser.png';
import ic19 from '../img/events.png';
import ic20 from '../img/feedbacks.png';
import ic21 from '../img/playlists.png';
import ic22 from '../img/barcodes.png';
import ic23 from '../img/like.png';
...
import qr_code_none from '../img/qr_code_none.png';
...
import { svg10String, svg11String, svg12String, svg13String, svg14String, svg15String, svg16String, svg1String, svg2String, svg3String, svg4String, svg5String, svg6String, svg7String, svg8String, svg9String } from './svgs';
...
import { handleScreenWidthTS } from '../Cases/DynamicCss';
...
const Hero = ({ handleregister }) => {
    ...
    const [Wa_Number, setWa_Number] = useState();
    ...
    const handleAction = () => {
        if (!userId) {
            // If no userId found, call handleSubmit
            handleSubmit();
        } else {
            // If userId exists, call Save_and_Download_Qr
            saveQRCode();
        }
    };
        ...
        if (container) {
            try {
                ...
                try {
                    ...
                    handleSubmits(data.url);

                    // Handle ssuccess: data contains information about the uploaded file
                } catch (error) {
    ...
    const handlemessagebox = (input) => {
        if (input === '') {
            setMessagebox("Field Is required")
        }
        else {
            setMessagebox("Scan to see");
        }
    }
        ...
        switch (activeTab) {
            ...
            case "Wi-Fi":
                return NetworkName && NetworkPassword && Type_of_encryption
                    ? `Wi-Fi Name: ${NetworkName}\nPassword: ${NetworkPassword}\nEncryption: ${Type_of_encryption}`
                    : null;

            case "vCard":
                return Name && Surname && PhoneNumber && Website && Company && Title
                    ? `BEGIN:VCARD\nVERSION:3.0\nN:${Surname};${Name};;;\nFN:${Name} ${Surname}\nORG:${Company}\nTITLE:${Title}\nTEL;TYPE=CELL:${PhoneNumber}\nURL:${Website}\nEND:VCARD`
                    : null;

            case "Email":
                return Email_tab && Email_Subject && Email_Message
                    ? `mailto:${Email_tab}?subject=${encodeURIComponent(Email_Subject)}&body=${encodeURIComponent(Email_Message)}`
                    : null;

            case "Whatsapp":
                return Wa_Number && WA_Message
    ...
    // const icons = new Array(tabs.length).fill(ic2); 
    const icons = [ic1, ic2, ic3, ic4, ic5, ic6, ic7, ic8, ic9, ic10, ic11, ic12, ic13, ic14, ic15, ic16, ic17, ic18, ic19, ic20, ic21, ic22, ic23];
    ...
    const [dynamicStyling, setdynamicStyling] = useState('')


    useEffect(() => {
        const updateWidth = () => setScreenWidth(window.innerWidth);

        console.log(screenWidth, "USEFFECT WIDTH")
        handleScreenWidthTS(screenWidth)
        setdynamicStyling(handleScreenWidthTS(screenWidth, buttonname))
        // Add resize event listener
        window.addEventListener('resize', updateWidth);

        // Cleanup the event listener
        return () => window.removeEventListener('resize', updateWidth);
    }, [window.innerWidth, buttonname]);

    // useEffect(() => {
    //     // Function to update the screen width
    //     const updateWidth = () => setScreenWidth(window.innerWidth);

    //     // Handle dynamic styling based on screen width and button name
    //     const styling = handleScreenWidthTS(screenWidth, buttonname);
    //     setdynamicStyling(styling);
    ...
    //     // Handle the canvas after the dynamic styling is set
    //     const canvas = qrCodeRef.current?.querySelector('canvas');
    //     if (canvas) {
    //         // Dynamically set the canvas width and height based on the updated styling
    //         canvas.width = dynamicStyling.qrwidth || 120;
    //         canvas.height = dynamicStyling.qrwidth || 120; // Set height similar to width or customize
    //     }

    //     // Cleanup: Remove the event listener on unmount
    //     return () => window.removeEventListener('resize', updateWidth);

    // }, [screenWidth, dynamicStyling.qrwidth, buttonname]);
    ...
    const setQrs = (e, wi, mar, bottom, btnname, active) => {
        ...
        console.log(btnname, "TS")

        const Styling = handleScreenWidthTS(screenWidth, btnname)
        setdynamicStyling(handleScreenWidthTS(screenWidth, btnname))
    ...
    useEffect(() => {
        ...
        if (qrCode) {
            qrCode.update({
                ...
                data: getQRCodeValue(), // Update the QR code data
                imageOptions: {
    ...
    }, [qrStyle, qrStyleCorners, qrStyledotCorners, socail, level, gradborderinput1, gradborderinput2, gradbordercornerinput1, gradbordercornerinput2, bordersquareconercolor, borderdotconercolor, gradbackground1, gradbackground2, gradicon1, gradicon2, color, bordercolor, qrCode, activeTab, url, Messagebox, NetworkName, NetworkPassword, Type_of_encryption, Name, Surname, PhoneNumber, Website, Company, Title, Email_tab, Email_Subject, Email_Message, Wa_Number, WA_Message, SMSNumber, SMSMessage]);
    ...
    useEffect(() => {
        ...
        const qrCodeInstance = new QRCodeStyling({
            ...
            height: 120,
            image: socail,
            data: getQRCodeValue(), // Set initial data 
            dotsOptions: {
                type: qrStyle, // Change the dots style dynamically
                color: bordercolor || "#000000", // Use the dynamic foreground color
                ...(useGradientsicons
    ...
    useEffect(() => {
        const handleScroll = () => {
            const boxPart1Height = document.querySelector('.box-part-1').offsetHeight;
            const scrollPosition = window.scrollY;

            // Adjust 300 based on the height of box-part-2
            if (scrollPosition > boxPart1Height - 300) {
                setIsFixed(false); // Set to relative once it reaches the bottom of the right div
            } else {
                setIsFixed(true);  // Keep fixed if scrolling within bounds
            }
        };
                        ...
                        <div className="hero-box">
                                ...
                                <div className="tab-1-hero">
                                    <Tabs>
                                                    ...
                                                    >
                                                        <button>
                                                            <span className='icon-hero'>
                                                                <img src={icons[index]} alt={tab.text} />
                                                            </span>
                                                            {tab.text}
                                                        </button>
                                                    </Tab>
                                        ...
                                        <div className="tab-box-hero-tital">
                                                    ...
                                                    <div className="qr-code-tab">
                                                        <Tabs>
                                                            <div className="qr-tab-btn">
                                                                <TabList>
                                                                    <Tab><button>{t('Framennn')}</button></Tab>
                                                                    <Tab><button>{t('shape_bk')}</button></Tab>
                                                                    <Tab><button>{t('logo_bk')}</button></Tab>
                                                                    <Tab><button>{t('level_bk')}</button></Tab>
                                                                </TabList>
                                                            </div>
                                                                ...
                                                                <TabPanel>
                                                                    ...
                                                                    <div className="ar-bar-box" >
                                                                        ...
                                                                        <button className='qr-card'
                                                                            ...
                                                                            onClick={(e) => {
                                                                                setQrs(qr_code_none, 140, 12, 10, "qr_code_none");

                                                                            }}

                                                                        >
                                                                            <img src={qr_code_none} alt=""
                                                                                style={{
                                                                                    width: '70%',
                                                                                    height: '60%'
                                                                                }}
                                                                        ...
                                                                        <button className='qr-card' onClick={() => setQrs(svg1String, 140, 12, 10, 'btn4', 1)}

                                                                            style={{
                                                                                border: borderactive === 1 ? '2px solid orange' : '',
                                                                            }}
                                                                        >
                                                                            <img src={btn4} alt="" />
                                                                        </button>

                                                                        <button className='qr-card' onClick={() => setQrs(svg2String, 140, 12, 10, 'btn4', 2)}
                                                                            style={{
                                                                                border: borderactive === 2 ? '2px solid orange' : '',
                                                                            }}>
                                                                            <img src={btn4} alt="" />
                                                                        </button>

                                                                        <button className='qr-card' onClick={() => setQrs(svg3String, 140, 12, 10, 'btn5', 3)}
                                                                            style={{
                                                                                border: borderactive === 3 ? '2px solid orange' : '',
                                                                            }}
                                                                        >
                                                                            <img src={btn5} alt="" />
                                                                        </button>

                                                                        <button className='qr-card' onClick={() => setQrs(svg4String, 120, 33, 56, 'btn11', 4)}

                                                                            style={{
                                                                                border: borderactive === 4 ? '2px solid orange' : '',
                                                                            }}>
                                                                            <img src={btn11} alt="" />
                                                                        </button>

                                                                        {/* <button className='qr-card' onClick={() => setQrs(svg5String, 120, 33, 10)}>
                                                                            <img src={btn8} alt="" />
                                                                        </button> */}

                                                                        <button className='qr-card' onClick={() => setQrs(svg1String, 120, 33, 10, 'btn9', 5)}
                                                                            style={{
                                                                                border: borderactive === 5 ? '2px solid orange' : '',
                                                                            }}>
                                                                            <img src={btn9} alt="" />
                                                                        </button>

                                                                        <button className='qr-card' onClick={() => setQrs(svg6String, 120, 33, 10, 'btn10', 6)}
                                                                            style={{
                                                                                border: borderactive === 6 ? '2px solid orange' : '',
                                                                            }}>
                                                                            <img src={btn10} alt="" />
                                                                        </button>

                                                                        <button className='qr-card' onClick={() => setQrs(svg7String, 120, 69, 160, 'btn7', 7)}
                                                                            style={{
                                                                                border: borderactive === 7 ? '2px solid orange' : '',
                                                                            }}>
                                                                            <img src={btn7} alt="" />
                                                                        </button>

                                                                        <button className='qr-card' onClick={() => setQrs(svg8String, 120, 39, 10, 'btn12', 8)}
                                                                            style={{
                                                                                border: borderactive === 8 ? '2px solid orange' : '',
                                                                            }}
                                                                        >
                                                                            <img src={btn12} alt="" />
                                                                        </button>

                                                                        <button className='qr-card' onClick={() => setQrs(svg9String, 120, 39, 15, 'btn15', 9)}
                                                                            style={{
                                                                                border: borderactive === 9 ? '2px solid orange' : '',
                                                                            }}
                                                                        >
                                                                            <img src={btn15} alt="" />
                                                                        </button>

                                                                        <button className='qr-card' onClick={() => setQrs(svg16String, 100, 39, 35, 'btn19', 10)}
                                                                            style={{
                                                                                border: borderactive === 10 ? '2px solid orange' : '',
                                                                            }}
                                                                        >
                                                                            <img src={btn19} alt="" />
                                                                        </button>

                                                                        <button className='qr-card' onClick={() => setQrs(svg10String, 120, 65, 10, 'btn17', 11)}
                                                                            style={{
                                                                                border: borderactive === 11 ? '2px solid orange' : '',
                                                                            }}
                                                                        >
                                                                            <img src={btn17} alt="" />
                                                                        </button>

                                                                        {/* <button className='qr-card' onClick={() => setQrs(svg11String, 120, 65, 10, 'btn14')}>
                                                                            <img src={btn14} alt="" />
                                                                        </button> */}

                                                                        <button className='qr-card' onClick={() => setQrs(svg12String, 110, 37, 35, 'btn20', 12)}
                                                                            style={{
                                                                                border: borderactive === 12 ? '2px solid orange' : '',
                                                                            }}
                                                                        >
                                                                            <img src={btn20} alt="" />
                                                                        </button>

                                                                        <button className='qr-card' onClick={() => setQrs(svg13String, 100, 50, 50, 'btn21', 13)}
                                                                            style={{
                                                                                border: borderactive === 13 ? '2px solid orange' : '',
                                                                            }}
                                                                        >
                                                                            <img src={btn21} alt="" />
                                                                        </button>

                                                                        <button className='qr-card' onClick={() => setQrs(svg14String, 100, 57, 10, 'btn18', 14)}
                                                                            style={{
                                                                                border: borderactive === 14 ? '2px solid orange' : '',
                                                                            }}
                                                                        >
                                                                            <img src={btn18} alt="" />
                                                                        </button>

                                                                        <button className='qr-card' onClick={() => setQrs(svg15String, 90, 25, 10, 'btn16', 15)}
                                                                            style={{
                                                                                border: borderactive === 15 ? '2px solid orange' : '',
                                                                            }}
                                                                        >
                                                                            <img src={btn16} alt="" />
                                                                        </button>
                                                            ...
                                                            <div className="qr-tab-box">
                                                                <TabPanel>
                                                                    ...
                                                                    <div className="Remember-box">
                                                                        <div className="remember-box">
                                                                            <p>{t('qrCodeReminder_bk')}</p>
                                                                            <h3>{t('borderAndBackground_bk')}</h3>
                                                                            ...
                                                                            {useGradientsbackground ? (
                                                                                ...
                                                                                <div className="long-box-inpt-faild">
                                                                                    ...
                                                                                    <div className="Transparent-cheack">
                                                                                        ...
                                                                                        <h3>{t('Transparent_background_bk')}</h3>
                                                                                    </div>
                                                                                </div>
                                            ...
                                            <TabPanel>
                                                <div className="Website-url-box">
                                                    <h2>{t('Message_tab_bk')} *</h2>
                                                    <textarea name="" id="" placeholder='Enter some text…' value={Messagebox}
                                                        onChange={(e) => {
                                                        ...
                                                        onBlur={(e) => {
                                                            if (!Messagebox) {
                                                                ...
                                                                e.target.style.borderColor = '#EAEAEC';
                                                            }
                                                        }}  >
                                                ...
                                                <div className="Website-url-box">
                                                    <div className="input-Network">
                                                        <div className="Network-in-box">
                                                            <h2>{t('Networkname_tab_bk')} (SSID) *</h2>
                                                            <input
                                                                type="text"
                                                        ...
                                                        <div className="selet-hero">
                                                            ...
                                                            <select
                                                                ...
                                                                onChange={(e) => {
                                                                    ...
                                                                    e.target.style.borderColor = e.target.value ? '#EAEAEC' : 'red';
                                                                }}
                                                                onFocus={(e) => {
                                                                    if (!Type_of_encryption) {
                                                                        e.target.style.borderColor = 'red';
                                                                    }
                                                                }}
                                                                onBlur={(e) => {
                                                            ...
                                                            >
                                                                <option value="WEP">{t('WEP_bk')}</option>
                                                                <option value="WPA">{t('WPA_bk')}</option>
                                                                <option value="WPA2-EAP">{t('WPA2_EAP')}</option>
                                                                <option value="nopass">{t('nopass_bk')}</option>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div className="cheack-hero">
                                                            <div class="checkbox-wrapper-33">
                                                                <label class="checkbox">
                                                                    ...
                                                                    <p class="checkbox__textwrapper">{t('Hidden_network_bk')}</p>
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <TabPanel>
                                                <div className="Website-url-box">
                                                    <div className="input-Network">
                                                        <div className="Network-in-box">
                                                            <h2>{t('Name_tab_bk')} *</h2>
                                                            <input type="text" placeholder='E.g. Paul' name='Name' value={Name} onChange={(e) => {
                                                        ...
                                                        <div className="Network-in-box">
                                                            <h2>{t('Surname_tab_bk')}</h2>
                                                            <input type="text" placeholder='E.g. Jones' name='Surname' value={Surname} onChange={(e) => {
                                                                ...
                                                                <AccordionItemPanel>
                                                                    <div className="input-Email">
                                                                            ...
                                                                            {fields.map((field, index) => (
                                                                                <div className='AddPhoneNumber' key={index}>
                                                                                    ...
                                                                                    <div className="hide-input">
                                                                                        <input type="text" placeholder='E.g.0000000' name='PhoneNumber' value={PhoneNumber} onChange={(e) => {
                                                                        ...
                                                                        <div className="Email-in-box">
                                                                            <h2>{t('NBres33')}*</h2>
                                                                            <input type="E.g. name@email.com" name='Email' value={Email}
                                                                        ...
                                                                        <div className="Email-in-box">
                                                                            <h2>{t('Personal_website_bk')}</h2>
                                                                            <input type="https://…" name='Website' value={Website}
                                                                                //   onChange={(e) => setWebsite(e.target.value); validateUrl(e.target.value);}
                                                            ...
                                                            <AccordionItem>
                                                                ...
                                                                <AccordionItemPanel>
                                                                    <div className="input-Network">
                                                                        <div className="Network-in-box">
                                                                            <h2>{t('NBfooter8')}</h2>
                                                                            <input type="text" placeholder='E.g. Company LLC' name='Company' value={Company}
                                                                                onChange={(e) => {
                                                                        ...
                                                                        <div className="Network-in-box">
                                                                            <h2>{t('Title_bk')}</h2>
                                                                            <input type="text" placeholder='E.g. Your profession/position' name='Title' value={Title} onChange={(e) => {
                                            ...
                                            <TabPanel>
                                                <div className="Website-url-box">
                                                    <div className="input-Email">
                                                        ...
                                                        <div className="Email-in-box">
                                                            <h2>{t('email')}*</h2>
                                                            <input type="email" name='Email' value={Email_tab} onChange={(e) => {
                                                        ...
                                                        <div className="Email-in-box">
                                                            <h2>{t('Subject_bk')}</h2>
                                                            <input type="text" name='Subject' value={Email_Subject} onChange={(e) => {
                                                        ...
                                                        <div className="Email-in-box">
                                                            <h2>{t('Message_tab_bk')}</h2>
                                                            <textarea name="" id="" value={Email_Message} onChange={(e) => {
                                            ...
                                            <TabPanel>
                                                <div className="Website-url-box">
                                                    <div className="input-Email">
                                                        ...
                                                        <div className="Email-in-box">
                                                            <h2>{t('Number_bk')}</h2>
                                                            <input type="text" name='WANumber' value={Wa_Number} onChange={(e) => {
                                                                setWa_Number(e.target.value)
                                                                e.target.style.borderColor = 'blue';
                                                        ...
                                                        <div className="Email-in-box">
                                                            <h2>{t('Message_tab_bk')}</h2>
                                                            <textarea name="" id="" value={WA_Message} onChange={(e) => {
                                                                setWA_Message(e.target.value)
                                                                e.target.style.borderColor = 'blue';
                                            ...
                                            <TabPanel>
                                                <div className="Website-url-box">
                                                    <div className="input-Email">
                                                        ...
                                                        <div className="Email-in-box">
                                                            <h2>{t('Number_bk')}</h2>
                                                            <input type="number" name='SMSNumber' value={SMSNumber} onChange={(e) => {
                                                        ...
                                                        <div className="Email-in-box">
                                                            <h2>{t('Message_tab_bk')}</h2>
                                                            <textarea name="" id="" value={SMSMessage} onChange={(e) => {
                                            ...
                                            <TabPanel>
                                                <div className="Website-url-box">
                                                    <div className="PDF-box">
                                                        <h4>{t('QR_Vcard_Plus_bk')}</h4>
                                                        <p>{t('Share_contact_details_bk')}</p>
                                                        <button onClick={handleregister}>{t('NBfooter3')}</button>
                                                    </div>
                                                </div>
                                            </TabPanel>
                                            ...
                                            <TabPanel>
                                                <div className="Website-url-box">
                                                    <div className="PDF-box">
                                                        <h4>{t('QR_Images_bk')}</h4>
                                                        <p>{t('Show_gallery_bk')}</p>
                                                        <button onClick={handleregister}>{t('NBfooter3')}</button>
                                            ...
                                            <TabPanel>
                                                <div className="Website-url-box">
                                                    <div className="PDF-box">
                                                        <h4>{t('QR_Video_bk')}</h4>
                                                        <p>{t('Share_video_with_QR_code')}</p>
                                                        <button onClick={handleregister}>{t('NBfooter3')}</button>
                                            ...
                                            <TabPanel>
                                                <div className="Website-url-box">
                                                    <div className="PDF-box">
                                                        <h4>{t('QR_List_Links')}</h4>
                                                        <p>{t('Group_links_bk')}</p>
                                                        <button onClick={handleregister}>{t('NBfooter3')}</button>
                                                    </div>
                                                </div>
                                            </TabPanel>
                                            ...
                                            <TabPanel>
                                                <div className="Website-url-box">
                                                    <div className="PDF-box">
                                                        <h4>{t('QR_Business_bk')}</h4>
                                                        <p>{t('Share_information_business_bk')}</p>
                                                        <button onClick={handleregister}>{t('NBfooter3')}</button>
                                            ...
                                            <TabPanel>
                                                <div className="Website-url-box">
                                                    <div className="PDF-box">
                                                        <h4>{t('QR_Menu_bk')}</h4>
                                                        <p>{t('Display_menu_restaurant_bk')}</p>
                                                        <button onClick={handleregister}>{t('NBfooter3')}</button>
                                            ...
                                            <TabPanel>
                                                <div className="Website-url-box">
                                                    <div className="PDF-box">
                                                        <h4>{t('QR_Coupon_bk')}</h4>
                                                        <p>{t('Share_coupon_bk')}</p>
                                                        <button onClick={handleregister}>{t('NBfooter3')}</button>
                                            ...
                                            <TabPanel>
                                                <div className="Website-url-box">
                                                    <div className="PDF-box">
                                                        <h4>{t('QR_Landing_page_bk')}</h4>
                                                        <p>{t('Create_your_page_bk')}</p>
                                                        <button onClick={handleregister}>{t('NBfooter3')}</button>
                                            ...
                                            <TabPanel>
                                                <div className="Website-url-box">
                                                    <div className="PDF-box">
                                                        <h4>{t('QR_Feedback_bk')}</h4>
                                                        <p>{t('Get_feedback_evaluations_bk')}</p>
                                                        <button onClick={handleregister}>{t('NBfooter3')}</button>
                                            ...
                                            <TabPanel>
                                                <div className="Website-url-box">
                                                    <div className="PDF-box">
                                                        <h4>{t('QR_Playlist_bk')}</h4>
                                                        <p>{t('Share_your_music_bk')}</p>
                                                        <button onClick={handleregister}>{t('NBfooter3')}</button>
                                            ...
                                            <TabPanel>
                                                <div className="Website-url-box">
                                                    <div className="PDF-box">
                                                        <h4>{t('QR_2D_arcode_bk')}</h4>
                                                        <p>{t('Supports_GS1_standards_bk')}</p>
                                                        <button onClick={handleregister}>{t('NBfooter3')}</button>
                                            ...
                                            <TabPanel>
                                                <div className="Website-url-box">
                                                    <div className="PDF-box">
                                                        <h4>{t('QR_Social_Media_bk')}</h4>
                                                        <p>{t('Share_social_profiles_bk')}</p>
                                                        <button onClick={handleregister}>{t('NBfooter3')}</button>
                            ...
                            <div className="box-part-2"
                                style={{
                                    ...
                                    top: isFixed ? '6em' : 'auto',
                                    right: isFixed ? '14em' : 'auto',
                                }}
                            >
                                <div className="Part-2-card">
                                    <div className="whiteback" ref={whiteback} style={{
                                        ...
                                        {qrCode && getQRCodeValue() ? (
                                            <div
                                                ...
                                                style={{
                                                    ...
                                                    // backgroundSize: `${dynamicStyling.backgroundSize}`,`
                                                    position: 'relative',
                                                    display: 'flex',
                                                    width: '225px',
                                                    height: '270px',
                                            ...
                                            >
                                                ...
                                                <div className='hello-1-4' style={{ position: 'absolute', bottom: bottomposition, color: textcolors, fontWeight: 'bold' }}>
                                                    {textcolor}
                                                </div>
                                                ...
                                                >
                                                    ...
                                                    <div id='qrCodeContainer' ref={qrCodeRef} style={{
                                                        position: 'relative',
                                                        marginTop: `${dynamicStyling.margintop}px`, marginLeft: `${dynamicStyling.marginleft}px`,
                                                        //  width: dynamicStyling.qrwidth  }}></div>
                                                    }}></div>
                                                </div>
                                            </div>
                                        ) : (
                                            <div className='hello00000'>
                                ...
                                <div className="hero-Download-box">
                                    <button
                                        ...
                                        style={{
                                            backgroundColor: getQRCodeValue() ? '#2947c7' : '#d9d9d9', // Change background color when qrCode exists
                                            border: getQRCodeValue() ? '1px solid #2947c7' : '1px solid initial', // Optional: Change border color if qrCode exists
                                            color: getQRCodeValue() ? '#fff' : 'initial',
                                        }}
                                    >
