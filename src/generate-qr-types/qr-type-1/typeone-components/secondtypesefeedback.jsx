...
import Secondtypeslider18 from "../../qr-type-9/type9-components/innersliders/secondtypeslider18";
import { useTranslation } from "react-i18next";

const Secondtypesecfeedback = ({ handleregister }) => {
      ...
      <section className="second_type_sec">
        <Container>
          <Row>
            ...
            <Col lg={12}>
              <Secondtypeslider18 handleregister={handleregister} />
            </Col>
          </Row>
        </Container>
      </section>
...
export default Secondtypesecfeedback;
