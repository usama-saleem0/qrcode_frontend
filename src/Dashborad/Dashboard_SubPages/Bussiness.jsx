...
const BussinessQr = () => {
  ...
  const [DescriptionEvent, setDescriptionEvent] = useState('Natural, artisan and local coffee. Open from Tuesday to Sunday from 8:00 am to 7:00 pm. Barista courses are held on Mondays.');
  ...
  const fetchBussinessQr = async (id) => {
   
    try {
      const response = await axios.get(`${baseurl}/getBusssinessQr/${id}`);
      setButtonDescription(response.data.data.ButtonDescription)
      setButtonURl(response.data.data.ButtonURl)
      setDescriptionEvent(response.data.data.DescriptionEvent)
      ...
      setselectedImagesinput(response.data.data.selectedImage)
  ...
  const deleteButtonField = (index) => {
    const newButtonFields = fieldsButton.filter((_, i) => i !== index);
    setfieldsButton(newButtonFields);
  };
  const addButtonPhoneField = () => {
    setfieldsButton([...fieldsButton, { type: 'Button', value: '' }]); // You can customize the default field properties
    setisButtonFieldAdded(!isButtonFieldAdded);
  };
  ...
  const handleSubmit1 = async (e) => {
    ...
    try {
      const response = await axios.post(`${baseurl}/updateTempleteBusiness/${id}`, {
        selectedCover,
        selectedImage,
        color,
        desFont,
      ...
      const data = {
        ...
        startTime,
        endTime,
        url:'https://qrn1.com/BusinessFullscreen',
        isChecked,
      ...
      toast.error("Error submitting Templte");
    ...
    try {
      const response = await axios.post(`${baseurl}/createtempletebusiness`, {
        selectedCover,
        selectedImage,
        color,
        desFont,
                          ...
                          <Accordion allowZeroExpanded>
                            ...
                            <AccordionItem>
                              ...
                              <AccordionItemPanel>
                                ...
                                <div className='imagediv' style={{ width: '50%' }}>
                          ...
                          <Accordion allowZeroExpanded>
                              ...
                              <AccordionItemPanel>
                                ...
                                <div className="iline">
                                  <div className="website--des">
                                    ...
                                    <input type="text" placeholder="Artist name" className='w-100' name='Name' value={Name} onChange={(e) => setName(e.target.value)} />
                                ...
                                <div className="iline">
                                  <div className="website--des">
                                    <p className='fontstitle'> Title</p>
                                    <input type="text" placeholder="Playlist title" className='w-100' name='TitleEvent' value={TitleEvent} onChange={(e) => setTitleEvent(e.target.value)} />
                                ...
                                <div className="iline">
                                  <div className="website--des">
                                    <p className='fontstitle'> Subtitle</p>
                                    <input type="text" placeholder="Our first single" className='w-100' name='DescriptionEvent' value={DescriptionEvent} onChange={(e) => setDescriptionEvent(e.target.value)} />
                                ...
                                <div style={{ width: '100%', paddingLeft: '20px', alignItems: 'flex-start', flexDirection: 'column' }} className='deteleiline'>
                                  <div className="hero-box-hide">
                                    ...
                                    {fieldsButton.map((Buttonfield, Buttonindex) => (

                                      <div className="w-100">

                                        <p>Button</p>
                                        <div className='AddPhoneNumber' key={Buttonindex}>
                                          <div className="hide-input">
                                            <input type="text" placeholder='Add button text here ' name='ButtonDescription' value={ButtonDescription} onChange={(e) => setButtonDescription(e.target.value)} />
                                          </div>

                                          <div className="hide-input">
                                            <input type="text" placeholder='https://...' name='ButtonURl' value={ButtonURl} onChange={(e) => setButtonURl(e.target.value)} />
                                          </div>
                                          <svg class="MuiSvgIcon-root" focusable="false" onClick={() => deleteButtonField(Buttonindex)}
                                  ...
                                  <div className="brand--back delete " onClick={addButtonPhoneField} style={{ cursor: 'pointer' }}>
                            ...
                            <AccordionItem>
                              ...
                              <AccordionItemPanel>
                                ...
                                <div className='uploadimage' style={{ border: '2px dashed red' }}>
                                  <ImageUploader style={{ margin: ' 0px 50px 0px 0px' }}
                            ...
                            <AccordionItem>
                              ...
                              <AccordionItemPanel>
                                ...
                                <Tabs>
                                  <TabList className="radio-inputs" style={{ width: '20%', cursor: 'pointer' }}>
                                  ...
                                  <TabPanel>
                                    <div className="iline">
                                      <div className="website--des">
                                        <p className='fontstitle'> Since</p>
                                    ...
                                    <div className="iline">
                                      <div className="website--des">
                                        <p className='fontstitle'> Until</p>
                                        <input type="date" className='w-100' />
                                      </div>
                                    </div>
                      ...
                      <div className='templetes1' style={{ backgroundImage: `url(${selectedCover || rain})`, }}>
                        ...
                        <div className='grad' style={{ background: `transparent ` }}>
                          ...
                          <div className='setlogs hero-li-list-box'>
                            ...
                            <div className='hell-box-inside' style={{ background: ` ${bottom}` }}>
                              ...
                              <span className='logsspan' style={{ fontFamily: titleFont }}>
                                ...
                                {TitleEvent ? TitleEvent : 'Full Stack dev'}
                              </span>


                              <h3>{DescriptionEvent}</h3>
