...
const MenuFullscreen = () => {
    ...
    const fetchQRtepmlete = async (id) => {
        try {
            const response = await axios.get(`${baseurl}/getqrtempleteMenuById/${id}`);
                                ...
                                <div className='grad hover-grad' style={{ background: `transparent ` }}>
                                    ...
                                    <div className='setlogs hero-li-list-box'>
                                        ...
                                        <div className='hell-box-inside hitx' style={{ background: ` ${qrtemplete.bottom}`, borderRadius: '0px' }}>
                                            ...
                                            <span className='logsspan' style={{ fontFamily: qrtemplete.titleFont, paddingBottom: '0px' }}>

                                                {qrtemplete.TitleEvent || 'Full Stack dev'}
                                            </span>


                                            <h3>{qrtemplete.Name || "We want to invite you to our wedding and enjoy a very special day together."}</h3>
