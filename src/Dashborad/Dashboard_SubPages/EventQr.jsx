...
const EventQr = () => {
  ...
  const fetchEventQr = async (id) => {
   
    try {
      const response = await axios.get(`${baseurl}/getEventQr/${id}`);
      ...
      setUntildate(response.data.data.Untildate)
  ...
  const handleSubmit1 = async (e) => {
    ...
    if(id){
      try {
        const response = await axios.post(`${baseurl}/updateEventTemplete/${id}`, {
          selectedCover,
          color,
          desFont,
          titleFont,
        ...
        const data = {
          ...
          startTime,
          endTime,
          url:'https://qrn1.com/EventFullscreen',
          isChecked,
      ...
      try {
        const response = await axios.post(`${baseurl}/createtempletevent`, {
          selectedCover,
          color,
          desFont,
          titleFont,
                            ...
                            <AccordionItem>
                              ...
                              <span className='coverimagespan'>
                                ...
                                <div className="iline">
                                  <div className="website--des">
                                    <p className='fontstitle'> Title</p>
                                    <input type="text" placeholder="Eg." className='w-100' name='TitleEvent' value={TitleEvent} onChange={(e) => setTitleEvent(e.target.value)} />
                                  </div>
                                ...
                                <div className="iline">
                                  <div className="website--des">
                                    ...
                                    <input type="text" placeholder="Eg." className='w-100' name='DescriptionEvent' value={DescriptionEvent} onChange={(e) => setDescriptionEvent(e.target.value)} />
                              ...
                              <AccordionItemPanel>
                                ...
                                <div className="iline">
                                  <div className="website--des">
                                    ...
                                    <input type="date" className='w-100' name='Sincedate' value={Sincedate} onChange={(e) => setSincedate(e.target.value)} />
                                ...
                                <div className="iline">
                                  <div className="website--des">
                                    ...
                                    <input type="date" className='w-100' name='Untildate' value={Untildate} onChange={(e) => setUntildate(e.target.value)} />
                            ...
                            <AccordionItem>
                              ...
                              <AccordionItemPanel>
                                ...
                                <div className="inline">
                                  ...
                                  <div className="website--des">
                                    <p className='fontstitle'>Calender</p>
                                    <input type="text" placeholder="Add to Calender" className='w-100' />
                                  </div>
                      ...
                      <div className='grad hover-grad' style={{ background: `transparent ` }}>
                        ...
                        <div className='setlogs hero-li-list-box'>
                          ...
                          <div className='hell-box-inside hitx' style={{ background: ` ${bottom}`,borderRadius:'0px'  }}>
                            ...
                            <h3>{DescriptionEvent || "We want to invite you to our wedding and enjoy a very special day together."}</h3>

                            <a href={ButtonURl}>
                            <button className='byn-box-in' style={{ background: ` ${top}`}}> {ButtonDescription|| "Confirm assistance"}</button>
                            </a>
