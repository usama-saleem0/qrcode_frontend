...
const Createtemplate = ({ qrCodeData, setQRCodeData }) => {
  ...
  const [qrTemplates, setQrTemplates] = useState(null);
  ...
  function getImageFileObject(imageFile) {
    ...
    if (imageFile instanceof File) {
      ...
      reader.onload = function (event) {
        ...
        setSocail(base64String); // Update your state with the base64 string
      };
  ...
  // const fetchQrTemplatesDetails = async () => {
  //   if (!id) {
  ...
  //   setLoading(true);
  //   try {
  //     const response = await axios.get(`${baseurl}/getQrTemplateDetails/${id}`);
  //     console.log('QR Code(s) retrieved successfully:', response.data);
  //     setQrTemplates(response.data.data); // Set the fetched QR template data
  //   } catch (error) {
  ...
  const fetchQrTemplatesDetails = async () => {
    ...
    try {
      ...
      // setQrTemplates(data); // Set the entire object if needed
      // setQRCode(data.QrCode || "");
      setName(data.Name || "");
      setwdth(data.wdth || "");
      setmargin(data.margin || "");
      setQRStyle(data.qrStyle || "");
      setqrStyleCorners(data.qrStyleCorners || "");
      setqrStyledotCorners(data.qrStyledotCorners || "");
      setSocail(data.socail || "");
      setLevel(data.level || "");
      setgradborderinput1(data.gradborderinput1 || "");
      setgradborderinput2(data.gradborderinput2 || "");
      setgradbordercornerinput1(data.gradbordercornerinput1 || "");
      gradbordercornerinput2(data.gradbordercornerinput2 || "");
      setbordersquareconercolor(data.bordersquareconercolor || "");
      setborderdotconercolor(data.borderdotconercolor || "");
      setgradbackground1(data.gradbackground1 || "");
      setgradbackground2(data.gradbackground2 || "");
      setgradicon1(data.gradicon1 || "");
      setgradicon2(data.gradicon2 || "");
      setColor(data.color || "");
  ...
  const handleSubmit = async (qrCodeUrl) => {
  ...
  useEffect(() => {
    const qrCodeInstance = new QRCodeStyling({
      ...
      dotsOptions: {
        type: qrStyle, // Change the dots style dynamically
        color: bordercolor || "#000000", // Use the dynamic foreground colord
        ...(useGradientsicons
          ? { // Use gradient if useGradientscorner is true
            gradient: {
              type: "linear", // or "radial"
                  ...
                  <AccordionItem>
                    ...
                    <AccordionItemPanel>
                      <div className="fram-box">
                        ...
                        <button onClick={() => setQrs(svg1String, 140, 12, 10)}><img src={btn4} alt="" /></button>
                        <button onClick={() => setQrs(svg2String, 140, 12, 10)}><img src={btn4} alt="" /></button>

                        <button onClick={() => setQrs(svg3String, 140, 12, 10)}><img src={btn5} alt="" /></button>

                        <button onClick={() => setQrs(svg4String, 120, 33, 56)}><img src={btn11} alt="" /></button>
                        <button onClick={() => setQrs(svg5String, 120, 33, 10)}><img src={btn8} alt="" /></button>
                        <button onClick={() => setQrs(svg1String, 120, 33, 10)}><img src={btn9} alt="" /></button>
                        <button onClick={() => setQrs(svg6String, 120, 33, 10)}><img src={btn10} alt="" /></button>
                        <button onClick={() => setQrs(svg7String, 120, 69, 160)}><img src={btn7} alt="" /></button>
                        <button onClick={() => setQrs(svg8String, 120, 39, 10)}><img src={btn12} alt="" /></button>


                        <button onClick={() => setQrs(svg9String, 120, 39, 15)}><img src={btn15} alt="" /></button>
                        <button onClick={() => setQrs(svg16String, 100, 39, 35)}><img src={btn19} alt="" /></button>
                        <button onClick={() => setQrs(svg10String, 120, 65, 10)}><img src={btn17} alt="" /></button>
                        <button onClick={() => setQrs(svg11String, 120, 65, 10)}><img src={btn14} alt="" /></button>
                        <button onClick={() => setQrs(svg12String, 110, 37, 35)}><img src={btn20} alt="" /></button>
                        <button onClick={() => setQrs(svg13String, 100, 50, 50)}><img src={btn21} alt="" /></button>
                        <button onClick={() => setQrs(svg14String, 100, 57, 10)}><img src={btn18} alt="" /></button>
                        <button onClick={() => setQrs(svg15String, 50, 25, 10)}><img src={btn16} alt="" /></button>
...
/> */}
                            <input
                              ...
                              onChange={(e) => {
                                ...
                                if (file) {
                                  getImageFileObject(file); // Pass the file to getImageFileObject function
                                }
                              }}
                            />
            ...
            <div className="main-content--b--image" style={{ width: '30%' }}>
              ...
              <div className='qrclass'>
                ...
                <div className="whiteback" style={{ position: 'relative' }} ref={whiteback}>
                  ...
                  {qrCode ? (
                    ...
                    >
                      ...
                      <div className='hello-1-2' style={{ position: 'absolute', bottom: bottomposition, color: textcolors, fontWeight: 'bold' }}>
                        {textcolor}
                      </div>
                ...
                <button onClick={saveQRCode} className='brand--save'>
                  Save
