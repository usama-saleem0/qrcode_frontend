...
const AppQr = () => {
  ...
  const fetchAppQr = async (id) => {

    try {
      const response = await axios.get(`${baseurl}/getAppQr/${id}`);
      ...
      SetgoogleUrl(response.data.data.googleurl)
      SetappleUrl(response.data.data.appleurl)
      SetamazonUrl(response.data.data.amazonurl)
  ...
  const handleSubmit1 = async (e) => {
    ...
    try {
      const response = await axios.post(`${baseurl}/updateapptemplete/${id}`, {
    ...
    try {
      const response = await axios.post(`${baseurl}/createapptemplete`, {
                            ...
                            <AccordionItem>
                              ...
                              <AccordionItemPanel>

                                    {
                                      google &&
                                      <div className="website--des">
                                    <p className='fontstitle'> Google</p>
                                    <input type="text" placeholder="Enter Url" className='w-100'
...

                                    {
                                      apple &&
                                      <div className="website--des">
                                    <p className='fontstitle'> Apple</p>
                                    <input type="text" placeholder="Enter Url" className='w-100'
                                    ...
                                    
{
                                      amazon &&
                                      <div className="website--des">
                                    <p className='fontstitle'> Amazon</p>
                                    <input type="text" placeholder="Enter Url" className='w-100'
                                ...
                                <div className="inline">
                                  <div class="radio-inputs" style={{ width: '100%' }}>
                                    ...
                                    <label class="radio" style={{ border: '2px solid black', marginLeft: '20px' }}  onClick={()=> AppLink('google')}>
                                      <input type="radio" name="radio" />
                                      <span class="name">Google </span>
                                    </label>

                                    <label class="radio" style={{ border: '2px solid black', marginLeft: '20px' }} onClick={()=> AppLink('apple')}>
                                      <input type="radio" name="radio" />
                                      <span class="name">Apple </span>
                                    </label>

                                    <label class="radio" style={{ border: '2px solid black', marginLeft: '20px' }} onClick={()=> AppLink('amazon')}>
                                      <input type="radio" name="radio" />
  ...
  <p className='logsp' >
    ...
    <div className="appdiv">
      ...
      <div className='applogo'>
        <img src={selectedlogo || logo} alt="App Logo" style={{borderRadius:'20px'}} />
      </div>
    ...
    <p
     ...
     className='  logsp ' style={{ fontFamily: desFont, fontSize: descriptionsize  }}>
      <a href={googleurl} style={{color:'white'}}>
      Google Play
      ...
      <p
       ...
       className='  logsp ' style={{ fontFamily: desFont, fontSize: descriptionsize  }}>
        <a href={appleurl} style={{color:'white'}}>
        App Store
      ...
      <p
       ...
       className='  logsp ' style={{ fontFamily: desFont, fontSize: descriptionsize  }}>
        <a href={amazonurl} style={{color:'white'}}>
        Amazon
        </a>
      </p>
        </div>  
