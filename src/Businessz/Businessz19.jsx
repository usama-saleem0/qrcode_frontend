...
import l1 from "../img/illustration-CTXBJSJh.webp" 
import l2 from "../img/banner-01-Dy6HloI-.webp" 
import l3 from "../img/banner-02-DT_QRX96.webp" 
import l4 from "../img/banner-03-7xH1HqpC.webp" 
import l5 from "../img/banner-04-ZKthaLMN.webp" 
import l7 from "../img/banner-05-CYqyFhLx.webp" 
...
const Businessz19= () => {
    ...
    return (
        <> 
            ...
            <Header />
            <section className="type_first_sec kd19">
    <Container>
        <Row className='hello-row'>
            <Col lg={8}>
                <div className="typepg_breadscrum">
                    ...
                    <span><IoChevronForwardSharp /></span>
                    <a href="#">{t('FinancialAndInsuranceCompaniesNB')}</a>
                </div>
                <div className="type_first_sec_txt">
                    <h2>{t('QRCodesForFinancialAndInsuranceCompaniesNB')}</h2>
                    <p className='total-spaas'>{t('IntegratingQRCodesDescriptionNB2')}</p>
        ...
        <Row>
            <Col lg={6}>
                <div className="create_type_txt">
                    <h3>{t('DiscoverMifintechNB')}</h3>
                    <p>{t('MifintechDescriptionNB')}</p>
                </div> 
            </Col>
            <Col lg={6}>
        ...
        <Row>
            ...
            <Col lg={6}>
                <div className="create_type_txt">
                    ...
                    <h3>{t('BoostYourNetworkNB')}</h3>
                    <p>{t('VcardDescriptionNB')}</p>
    ...
    <Container>
        <Row>
            <Col lg={6}>
                <div className="create_type_txt">
                    <h6>{t('PDFQRCodeNB')}</h6>
                    <h3>{t('RevolutionizesPresentationNB')}</h3>
                    <p>{t('PDFQRCodeDescriptionNB2')}</p>
                    <div className="more-end-btn-box">
                        <button className='hello-cr'>{t('CreateQRCodeNB')}</button>
                        <button className='More-Info'>{t('MoreInfoNB')}</button>
                    </div>
        ...
        <Row>
            ...
            <Col lg={6}>
                <div className="create_type_txt">
                    ...
                    <h3>{t('FacilitatesAccessNB')}</h3>
                    <p>{t('AppsQRCodeDescriptionNB2')}</p>
                    <div className="more-end-btn-box">
                        <button className='hello-cr'>{t('CreateQRCodeNB')}</button>
                        <button className='More-Info'>{t('MoreInfoNB')}</button>
                    </div>
        ...
        <Row>
            ...
            <Col lg={6}>
                <div className="create_type_txt">
                    ...
                    <h3>{t('BoostInteractionNB')}</h3>
                    <p>{t('LinkListingDescriptionNB')}</p>
                    <div className="more-end-btn-box">
                        <button className='hello-cr'>{t('CreateQRCodeNB')}</button>
                        <button className='More-Info'>{t('MoreInfoNB')}</button>
                    </div>
        ...
        <Row>
            <Col lg={6}>
                <div className="create_type_txt">
                    ...
                    <h3>{t('HumanizeYourBrandNB')}</h3>
                    <p>{t('VideoQRCodeDescriptionNB11')}</p>
                    <div className="more-end-btn-box">
                        <button className='hello-cr'>{t('CreateQRCodeNB')}</button>
                        <button className='More-Info'>{t('MoreInfoNB')}</button>
                    </div>
